                ...
                if participant['participantId'] == participantInfo['participantId']:
                    ...
                    newPlayer = Player(
                        ...
                        # Stats
                            ...
                            neutralMinionsKilledTeamJungle = participant['stats']['neutralMinionsKilledTeamJungle'] if 'neutralMinionsKilledTeamJungle' in participant['stats'] else 0,
                            neutralMinionsKilledEnemyJungle = participant['stats']['neutralMinionsKilledEnemyJungle'] if 'neutralMinionsKilledEnemyJungle' in participant['stats'] else 0,
                            ...
                            perkPrimaryStyle = participant['stats']['perkPrimaryStyle'] if 'perkPrimaryStyle' in participant['stats'] else 0,
                            perkSubStyle = participant['stats']['perkSubStyle'] if 'perkSubStyle' in participant['stats'] else 0,
